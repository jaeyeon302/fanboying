...
OUTPUT_VIDEO_PATH = "./only_jeon_multi.mp4"#"./fancy_jihyo2.mp4"#"./test.mp4"
INPUT_VIDEO_PATH = "./jeon.mp4"#"./videoplayback-2.mp4"#"./jeon.mp4"

__TOLERANCE = 0.4
__STD_PROCESS_VIDEO_WIDTH = 320

analyzing_frame_delta, target_face_encoding, tolerance = None,None,None

Opts = nt("Opts","input_video_file_name target_face_encoding resizing_scale analyzing_frame_delta tolerance")
...
def find_target_face(input_video_file_name,frame_range):
    ...
    for frame_number in range(s,e,analyzing_frame_delta):
        ...
        if matched and not saving:
            ...
            saving = False
            interest_section.append((section_start, frame_number))
...
def main(target_face_img_name,input_video_file_name,output_file_name,std_process_video_width,tolerance):
    ...
    trim_to_audio_subclips(input_video_file_name,matched_time_section,tmp_audio_file_name)
...
def trim_to_audio_subclips(input_video_file_name,matched_time_section,output_file_name):
